(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_50e18bd6._.js", {
...
function TaskDetailView({ taskId }) {
        ...
        "TaskDetailView.useEffect": ()=>{
            ...
            if (foundTask) {
                ...
                if (foundTask.assigneeId) {
                    setAssignee(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockUsers"].find({
                        "TaskDetailView.useEffect": (u)=>u.id === foundTask.assigneeId
                    }["TaskDetailView.useEffect"]) || null);
                }
                if (foundTask.dependencies && foundTask.dependencies.length > 0) {
                    setDependencies(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"].filter({
                        "TaskDetailView.useEffect": (t)=>foundTask.dependencies.includes(t.id)
                    }["TaskDetailView.useEffect"]));
                }
            }
        }
    ...
    const handleUpdateProgress = (id, progress)=>{
        if (task && task.id === id) {
            ...
            if (taskIndex !== -1) __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"][taskIndex] = updatedTask;
            toast({
...
_s(TaskDetailView, "Ih9xeq+pCoy9vMdCMZo5vKkZc7Q=", false, function() {
    return [
...
function TaskPage({ params }) {
    ...
    const [task, setTask] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined); // undefined for initial, null if not found
    const [loadingTask, setLoadingTask] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TaskPage.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TaskPage.useEffect": ()=>{
            const foundTask = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"].find({
                "TaskPage.useEffect.foundTask": (t)=>t.id === params.id
...
_s(TaskPage, "IUip63mxfEGF9e/VyMEZHdVvDXs=", false, function() {
    return [
...
//# sourceMappingURL=src_50e18bd6._.js.map