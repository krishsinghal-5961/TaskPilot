(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_3ada5390._.js", {
...
const taskFormSchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["object"])({
    ...
    dueDate: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["date"])().optional(),
    assigneeId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["string"])(),
...
function TaskForm({ task, onSubmitSuccess }) {
    _s();
    ...
    const defaultValues = {
        ...
        dueDate: task?.dueDate ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(task.dueDate) : undefined,
    ...
    function onSubmit(data) {
        ...
        const taskMutationData = {
            title: data.title,
            description: data.description,
            status: data.status,
            priority: data.priority,
            dueDate: data.dueDate ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(data.dueDate, "yyyy-MM-dd") : undefined,
            assigneeId: data.assigneeId === UNASSIGNED_VALUE ? undefined : data.assigneeId,
            dependencies: data.dependencies,
            progress: calculatedProgress
        };
        if (task && task.id) {
            const taskIndex = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"].findIndex((t)=>t.id === task.id);
            if (taskIndex !== -1) {
    ...
    const availableDependencies = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mockTasks"].filter((t)=>t.id !== task?.id);
...
_s(TaskForm, "/i/5rmdTfHly2HJ/DbqpID9OKxA=", false, function() {
    return [
...
//# sourceMappingURL=src_3ada5390._.js.map